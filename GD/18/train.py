...
class Trainer(object):
    ...
    def save_model(self, epoch, loss):
        model_name = './models/{}/model-v{}-epoch-{}.h5'.format(self.model_name,
            self.version, epoch)
...
def train(epochs, start_epoch, learning_rate, tensorboard_dir, checkpoint,
          num_heatmap, batch_size, train_tfrecords, val_tfrecords, version,model_name):
